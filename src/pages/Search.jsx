    ...
    <>
      <div className="bg-white">
        ...
        <div id="results" ref={resultRef}>
          {movies.length > 0 && (
            <>
              <p className="py-10 text-red-600 text-center pb-15 text-xl sm:text-2xl lg:text-4xl font-bold">
          ...
          {movies.length === 0 && series.length === 0 && (
            <div>
              <p className="text-center text-red-600 text-xl md:text-2xl lg:text-4xl my-5 md:my-10">
              ...
              >
                <img
                  className="w-130 border-2 border-black"
                  src={NotFound}
                  alt=""
                />
              </div>
