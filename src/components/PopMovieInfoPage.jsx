...
function PopMovieInfoPage({ info }) {
  const image = useRef(null);

  return (
    <div
      key={info.id}
      className="flex flex-col px-5 justify-center gap-5 md:gap-10 items-center bg-white dark:bg-black text-white md:flex-row md:py-10 lg:pt-20 lg:pb-10"
    >
      ...
      <div className="rounded-2xl py-5 mb-5 bg-gray-200 dark:bg-gray-800">
        <div className="flex flex-col justify-center items-center mt-2 text-black dark:text-white">
...
export default PopMovieInfoPage;
